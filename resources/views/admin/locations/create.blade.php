<x-layouts.app title="Tambah Lokasi Server">
    <div class="p-6 bg-white rounded shadow dark:bg-zinc-800 max-w-xl mx-auto">
        <h1 class="text-2xl font-bold mb-4 text-zinc-800 dark:text-white">Tambah Lokasi Server Baru</h1>
        ...
        <form action="{{ route('admin.locations.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="gedung" name="gedung" value="{{ old('gedung') }}" required
